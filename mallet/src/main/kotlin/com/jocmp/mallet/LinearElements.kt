...
data class LinearTable(
    ...
    val rowCount: Int,
    val colCount: Int,
    private val cellsReal: LinkedHashMap<Coordinate, LinearTableCellItem>,
) : LinearElement {
    ...
    constructor(
        ...
        rowCount,
        colCount,
        LinkedHashMap<Coordinate, LinearTableCellItem>().apply {
    ...
    class Builder(
        ...
        private val cells: LinkedHashMap<Coordinate, LinearTableCellItem> = LinkedHashMap()
