...
class ArticleRecordsTest {
    ...
    fun markUnread() {
        ...
        val reloaded = articleRecords.findArticleBlocking(articleID = article.id)!!
    ...
    fun markAllUnread() {
        ...
        val articles = articleIDs.map { articleRecords.findArticleBlocking(it)!! }

        assertTrue(articles.none { it.read })
        assertTrue(articleRecords.findArticleBlocking(readArticle.id)!!.read)
    }
    ...
    fun deleteOldArticles() {
        ...
        val oldStarredArticle = articleFixture.create(publishedAt = oldPublishedAt).run {
            ...
            articleRecords.findArticleBlocking(id)!!
        }
