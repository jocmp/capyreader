...
/**
 * A [NestedScrollConnection] that provides scroll events to a hoisted [PullToLoadState].
 *
...
/**
 * A state object that can be used in conjunction with [ReaderNestedScrollConnection] to add
 * pull-to-load behaviour to a scroll component. Based on Android's SwipeRefreshLayout.
 *
...
class PullToLoadState internal constructor(
     ...
     *
     * @return The offset fraction currently of this state, could be negative if the content is
     * pulling up
     */
