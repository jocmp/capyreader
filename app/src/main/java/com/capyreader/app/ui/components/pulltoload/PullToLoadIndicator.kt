package com.capyreader.app.ui.components.pulltoload
...
import com.capyreader.app.ui.components.pulltoload.PullToLoadState.Status.Idle
import com.capyreader.app.ui.components.pulltoload.PullToLoadState.Status.PulledDown
import com.capyreader.app.ui.components.pulltoload.PullToLoadState.Status.PulledUp
import com.capyreader.app.ui.components.pulltoload.PullToLoadState.Status.PullingDown
import com.capyreader.app.ui.components.pulltoload.PullToLoadState.Status.PullingUp
...
fun BoxScope.PullToLoadIndicator(
    ...
    topSwipeIcon: ImageVector? = null,
    bottomSwipeIcon: ImageVector? = null,
) {
    ...
    val imageVector = when (status) {
        PulledDown -> topSwipeIcon ?: Icons.Rounded.KeyboardArrowUp
        PulledUp -> bottomSwipeIcon ?: Icons.Rounded.KeyboardArrowDown
        else -> null
    }
