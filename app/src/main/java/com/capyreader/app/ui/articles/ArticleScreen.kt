...
import com.capyreader.app.ui.articles.list.ArticleListDetailLayout
...
//                openNextList { viewModel.selectFeed(feed.id, folderTitle) }
        ...
        ModalNavigationDrawer(
            ...
            NavHost(navController, startDestination = Route.EmptyArticleListDetail) {
                composable<Route.ArticleListDetail>(typeMap = WrappedArticleFilter.typeMap) {
                    ArticleListDetailLayout()
                }
                composable<Route.EmptyArticleListDetail> {
                }
            }
        }
//
